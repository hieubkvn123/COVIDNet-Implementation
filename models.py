...
def get_small_covid_net(H, W, C, n_classes=2, batchnorm=True):
    ...
    # Pepx stage 1
    pepx11 = get_pepx_module(H//4, W//4, 56, 56, name='pepx_11', batchnorm=batchnorm)(pool1)
    pepx12 = get_pepx_module(H//4, W//4, 56, 56, name='pepx_12', batchnorm=batchnorm)(pepx11 + out_conv1_1x1)
    pepx13 = get_pepx_module(H//4, W//4, 56, 56, name='pepx_13', batchnorm=batchnorm)(pepx11 + pepx12 + out_conv1_1x1)
    ...
    # Pepx stage 2
    pepx21 = get_pepx_module(H//8, W//8, 56, 112, name='pepx_21', batchnorm=batchnorm)(
        MaxPooling2D((2,2))(pepx11) + MaxPooling2D((2,2))(pepx12) + MaxPooling2D((2,2))(pepx13) + MaxPooling2D((2,2))(out_conv1_1x1)    
    )
    pepx22 = get_pepx_module(H//8, W//8, 112, 112, name='pepx_22', batchnorm=batchnorm)(pepx21 + out_conv2_1x1)
    pepx23 = get_pepx_module(H//8, W//8, 112, 112, name='pepx_23', batchnorm=batchnorm)(pepx21 + pepx22 + out_conv2_1x1)
    pepx24 = get_pepx_module(H//8, W//8, 112, 112, name='pepx_24', batchnorm=batchnorm)(pepx21 + pepx22 + pepx23 + out_conv2_1x1)
    ...
    # Pepx stage 3
    pepx31 = get_pepx_module(H//16, W//16, 112, 216, name='pepx_31', batchnorm=batchnorm)(
    ...
    pepx32 = get_pepx_module(H//16, W//16, 216, 216, name='pepx_32', batchnorm=batchnorm)(pepx31 + out_conv3_1x1)
    pepx33 = get_pepx_module(H//16, W//16, 216, 216, name='pepx_33', batchnorm=batchnorm)(pepx31 + pepx32 + out_conv3_1x1)
    pepx34 = get_pepx_module(H//16, W//16, 216, 216, name='pepx_34', batchnorm=batchnorm)(pepx31 + pepx32 + pepx33 + out_conv3_1x1)
    pepx35 = get_pepx_module(H//16, W//16, 216, 216, name='pepx_35', batchnorm=batchnorm)(pepx31 + pepx32 + pepx33 + pepx34 + out_conv3_1x1)
    pepx36 = get_pepx_module(H//16, W//16, 216, 216, name='pepx_36', batchnorm=batchnorm)(pepx31 + pepx32 + pepx33 + pepx34 + pepx35 + out_conv3_1x1)
    ...
    # Pepx stage 4
    pepx41 = get_pepx_module(H//32, W//32, 216, 424, name='pepx_41', batchnorm=batchnorm)(
    ...
    pepx42 = get_pepx_module(H//32, W//32, 424, 424, name='pepx_42', batchnorm=batchnorm)(pepx41 + out_conv4_1x1)
    pepx43 = get_pepx_module(H//32, W//32, 424, 424, name='pepx_43', batchnorm=batchnorm)(pepx41 + pepx42 + out_conv4_1x1)
